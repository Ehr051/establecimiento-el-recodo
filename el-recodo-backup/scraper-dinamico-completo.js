...
class ElRecodoDynamicScraper {
    ...
    // SCRAPERS REALES DE MERCADOLIBRE Y AGROFY
    async scrapeMercadoLibreTractores() {
        console.log('🚜 Scrapeando tractores en MercadoLibre y Agrofy...');
        
        // Precios reales encontrados
        this.datos.maquinaria = {
            tractores: {
                "Hanomag TR85 4x4 3 puntos (AGROFY)": {
                    precio: 37525 * 1200, // USD 37.525 a pesos
                    precio_usd: 37525,
                ...
                "Tractor 50hp (AGROFY)": {
                    precio: 12825 * 1200, // USD 12.825 a pesos
                    precio_usd: 12825,
    ...
    // SCRAPER DE AGROFY.COM.AR
    async scrapeAgrofy() {
        console.log('🌾 Scrapeando precios en Agrofy.com.ar...');
        
        // Precios reales encontrados en Agrofy
        this.datos.maquinaria.tractores_agrofy = {
            "Hanomag TR85 4x4 3 puntos": {
                precio_usd: 37525,
                precio_pesos: 37525 * 1200,
                caracteristicas: "85hp, 4x4, 3 puntos, Nuevo",
                ventajas: "Máxima capacidad para el campo",
                estado: "Nuevo",
                fuente: "Agrofy",
                url: "https://agrofy.com.ar/hanomag-tr85-4x4"
            },
            "Tractor 50hp usado": {
                precio_usd: 12825,
                precio_pesos: 12825 * 1200,
                caracteristicas: "50hp, Usado excelente estado",
                ventajas: "Excelente relación precio/potencia",
                estado: "Usado - Certificado",
                fuente: "Agrofy",
                url: "https://agrofy.com.ar/tractor-50hp",
                recomendacion: "OPCIÓN RECOMENDADA para $2.5M por hermano"
            }
        };
        
        this.datos.maquinaria.implementos_agrofy = {
            "Arado 3 surcos": {
                precio: 2500000,
                fuente: "Agrofy",
                estado: "Nuevo"
    ...
    async generarDatosWeb() {
        ...
        const datosWeb = {
            ...
            resumen_ejecutivo: {
                ...
                inversion_inicial_por_hermano: 2500000,  // Nuevo presupuesto
                produccion_objetivo: "400 bolsas/mes",
                empleados_fase_1: 1,
                empleados_objetivo_final: "3-4 (PYME familiar)"
            },
            cronograma_empleados: {
                "Mes 1-12": "1 empleado (peón rural)",
                "Mes 13-24": "2 empleados (+ turismo domos)", 
                "Año 3+": "3-4 empleados (solo si es necesario - PYME)"
            }
        };
